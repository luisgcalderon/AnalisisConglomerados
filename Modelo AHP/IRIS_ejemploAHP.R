...
#Ejemplos ClusterAnalysis AHP IrisSet
...
psi.c2<-EMAlgorithmMV(dato = x,g = 2,psi = psi.c2,metodo = "verosi",difmin = 0.0001)
psi.c3<-EMAlgorithmMV(dato = x,g = 3,psi = psi.c3,metodo = "verosi",difmin = 0.0001)
psi.c4<-EMAlgorithmMV(dato = x,g = 4,psi = psi.c4,metodo = "verosi",difmin = 0.0001)
psi.c5<-EMAlgorithmMV(dato = x,g = 5,psi = psi.c5,metodo = "verosi",difmin = 0.0001)
